...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-rn-bg pb-20">
      {/* Hero Section */}
      <section className="relative pt-16 md:pt-20 pb-16 bg-gradient-to-b from-white to-rn-surface border-b border-rn-border overflow-hidden">
        {/* Background Mesh Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full bg-rn-blue/5 border border-rn-blue/10 text-rn-blue text-xs font-semibold uppercase tracking-wider mb-4 shadow-sm">
            <Sparkles size={12} />
            <span>Our Portfolio</span>
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-rn-text tracking-tight mb-6 leading-tight max-w-3xl mx-auto">
            Engineered for performance. Built for scale.
          </h1>
          <p className="text-base md:text-lg text-rn-text-muted max-w-2xl mx-auto leading-relaxed">
            Explore our case studies. We build clean, modular codebases designed to automate operations and drive business growth.
          </p>

          {/* Stats Bar */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto mt-12 pt-8 border-t border-rn-border text-center">
            <div>
              <p className="text-3xl font-bold text-rn-text">5+</p>
              <p className="text-xs text-rn-text-muted font-medium uppercase mt-1 tracking-wider">Enterprise Systems</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-rn-text">100%</p>
              <p className="text-xs text-rn-text-muted font-medium uppercase mt-1 tracking-wider">Client Satisfaction</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-rn-text">99.9%</p>
              <p className="text-xs text-rn-text-muted font-medium uppercase mt-1 tracking-wider">Uptime Delivery</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-rn-text">10k+</p>
              <p className="text-xs text-rn-text-muted font-medium uppercase mt-1 tracking-wider">Hours Engineered</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 pb-4 border-b border-rn-border">
          {categories.map((cat) => (
            <button
              key={cat}
              ...
              className={`px-4 py-2 text-xs font-semibold rounded-lg transition-all cursor-pointer ${
                activeCategory === cat
                  ? 'bg-rn-text text-white shadow-sm'
                  : 'bg-white border border-rn-border text-rn-text-muted hover:text-rn-text hover:bg-rn-surface'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
            ...
            {filteredProjects.map((project, idx) => (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-rn-text/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                    <span className="bg-white/95 px-3 py-1.5 rounded-lg shadow text-[10px] font-bold text-rn-text flex items-center gap-1.5">
                      <Eye size={12} />
                ...
                <div className="p-6 flex-grow flex flex-col justify-between">
                  <div>
                    <span className="text-[10px] font-bold text-rn-blue bg-rn-blue/5 border border-rn-blue/10 px-2.5 py-0.5 rounded-md uppercase tracking-wider">
                      {project.category}
                    </span>
                    <h3 className="text-lg font-semibold text-rn-text mt-3 group-hover:text-rn-blue transition-colors">
                      {project.title}
                    </h3>
                    <p className="text-xs text-rn-text-muted mt-2 leading-relaxed">
                      {project.description}
                    </p>
                  </div>
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-20 bg-white border border-rn-border rounded-2xl p-6">
            <p className="text-rn-text-muted text-sm font-medium">No projects found in this category.</p>
          </div>
        )}
      </div>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-rn-text/40 backdrop-blur-sm"
            />
              ...
              <div className="p-6 space-y-6 flex-grow overflow-y-auto hide-scrollbar">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-rn-text-muted font-mono">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="w-8 h-8 rounded-lg border border-rn-border bg-white flex items-center justify-center text-rn-text-muted disabled:opacity-40 disabled:cursor-not-allowed hover:bg-rn-surface transition-colors cursor-pointer"
      ...
      <section className="max-w-6xl mx-auto px-4 mt-20">
        <div className="bg-rn-text text-white rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-xl text-center">
          ...
          <div className="relative z-10">
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-white hover:bg-gray-100 text-rn-text font-semibold text-sm transition-colors shadow-md"
            >
